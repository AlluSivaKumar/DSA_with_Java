...
public class Code6 
{
    public static void main(String[] args) {
        ...
        System.out.print("Enter the Number of baloons : ");
        int n = sc.nextInt();

        sc.nextLine();
        
        String[] arr = new String[n];
        System.out.print("Enter the the First character of baloon of its colour : ");
        for(int i=0;i<arr.length;i++)
        {
            arr[i] = sc.nextLine().toLowerCase(); 
        }
        FirstOccuranceOddBalloon(arr);
        sc.close();
    }

    public static void FirstOccuranceOddBalloon(String[] arr)
    {
